...
export const WindSpeed: FC = () => {
  const score = 10;
  return (
    <div className="w-full h-full rounded-3xl min-h-[180px] bg-blue-600 border-2 border-blue-450 flex flex-col items-center relative justify-center pl-6 pr-6 pt-3 pb-1">
